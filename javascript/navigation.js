...
navLinks[3].addEventListener('click', (e) => {
    ...
    Swal.fire({
        ...
        html:
          `<br><h2>Podés encontrarme acá ↓</h2><br><a href="https://www.linkedin.com/in/santiago-sottocasa-675743b6/" target="_blank"><i class="fa-brands fa-linkedin-in fa-4x" style="color: #00BCE1; filter: drop-shadow(0 0 0.1rem #00BCE1);" alt='linkedIn link'></i></a>`,
        focusConfirm: false,
        background: '#051C2C',
        color: '#fff',
        confirmButtonText:
